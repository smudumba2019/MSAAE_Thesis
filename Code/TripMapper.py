...
class TripMapper(LoadExistingUAMaerodromeInfrastructure):
    ...
    def PlotFlightProfiles(self,Aircraft,CruiseAltitudeInFeet):
        ...
        FP2 = FlightProfile(Aircraft, 1500, self.TripDistanceNonDirectRoute)
        ...
        if self.plotgraphs == True:
            ...
            plt.tight_layout()
            plt.savefig('C:/Users/saimu/Documents/AAE_MS_Thesis_Documentation_v2/Python_Code/Results/Miscellaneous/FlightProfileDirectRoute.png', dpi=600)
        # plt.show()
    ...
    def FindClosestUAMaerodromeAlongTheRoute(self):
        ...
        for j in range(len(self.LatArrayforAllWaypoints_inMerc_flattened)): # j represents the each step of the vehicle along the path
            ...
            for l in range(len(self.lat_heliports_deg)): # l represents each location index of heliports
                ...
                Distance2ContingencySite_Heliport.append(1000000000000)
        ...
        if self.plotgraphs == True:
            ...
            ax3.grid()
            plt.savefig('C:/Users/saimu/Documents/AAE_MS_Thesis_Documentation_v2/Python_Code/Results/Miscellaneous/HeadingDirectionVsTripLength_nonDirect.png', dpi=600)
